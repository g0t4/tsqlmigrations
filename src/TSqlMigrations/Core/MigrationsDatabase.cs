    ...
    public class MigrationsDatabase
    {
        ...
        public void Backup(string fileName)
        {
            var backup = new Backup
            {
                ...
                Incremental = false,
                CompressionOption = GetCompressionOptions(),
                Initialize = true,
                FormatMedia = true,
                SkipTapeHeader = true
            };
        ...
        private BackupCompressionOptions GetCompressionOptions()
        {
            return _migrationsServer.GetServer().Edition.Contains("Standard") ?
                BackupCompressionOptions.Off : BackupCompressionOptions.On;
        }
    }
}